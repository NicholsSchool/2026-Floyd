...
public class AutoConstants {
    ...
    public static final Pose2d RIGHT_SHOOT_POS = new Pose2d(new Translation2d(3.0, 2.8), new Rotation2d(Math.toRadians(40.0)));

    public static final Pose2d CENTER_SHOOT_POS = new Pose2d(new Translation2d(3.0, 4.0), new Rotation2d(Math.toRadians(0.0)));

    public static final Pose2d LEFT_SHOOT_POS = new Pose2d(new Translation2d(3.0, 5.3), new Rotation2d(Math.toRadians(-40.0)));

    public static final double INTAKE_TIME = 5.0;
