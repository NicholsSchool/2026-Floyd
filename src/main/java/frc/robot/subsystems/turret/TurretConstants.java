...
public class TurretConstants {
    ...
    public static final double TURRET_MAX_ANGLE = Math.toRadians(80.0);
    public static final double TURRET_MIN_ANGLE = Math.toRadians(-80.0);
    ...
    public static final double TURRET_FEED = 0.18;
