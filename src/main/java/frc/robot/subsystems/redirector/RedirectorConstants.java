...
public class RedirectorConstants {
    public static final double REDIRECTOR_P = 0.1; //TODO: Tune these PID constants
    public static final double REDIRECTOR_I = 0.0;
    public static final double REDIRECTOR_D = 0.0;
    public static final double REDIRECTOR_MAX_ACCEL_RAD = 100.0;
    ...
    public static final double REDIRECTOR_CURRENT_LIMIT = 40.0;
